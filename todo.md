...
## 🧪 FEATURE - Bybit Testnet Desteği
- [ ] Testnet API endpoint'i ekle (https://api-testnet.bybit.com)
- [ ] Dashboard'da mainnet/testnet seçimi ekle
- [ ] Testnet modu göstergesi
- [ ] Bot testnet'te işlem açabilsin
- [ ] Testnet'te kar/zarar hesaplaması


## ✅ DONE - Mainnet/Testnet Desteği
- [x] Testnet API endpoint'i ekle
- [x] Mainnet/Testnet seçimi dashboard'da
- [x] Bot mainnet'te işlem açabilir
- [x] Mainnet'te kar/zarar hesaplaması
